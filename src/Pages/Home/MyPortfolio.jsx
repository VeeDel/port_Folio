  ...
  return (
    <section className="portfolio--section" id="MyPortfolio">
      <div className="portfolio--container-box">
        ...
        <div>
          <a target="_blank" href="https://github.com/VeeDel">
      ...
      <h2 className="section--heading">Web Designs</h2>

      <div className="portfolio--section--container grid-designs">
        {data?.webDesign?.map((item, index) => (
          <div key={index} className="portfolio--section--card">
            <a href={item.links} target="_blank" rel="noopener noreferrer">
              {" "}
              <div className="portfolio--section--img">
            ...
            <div className="portfolio--section--card--content">
              <div>
                ...
                <a href={item.links} target="_blank" rel="noopener noreferrer">
                  {" "}
                  <button class="button">{item.link}</button>
                </a>
              </div>
            </div>
          </div>
